...
|          | [litlab (main)](https://github.com/jackyuyz/litlab)                | **litlab-mobile (this repo)**                                              |
| -------- | ------------------------------------------------------------------ | -------------------------------------------------------------------------- |
...
- **Sign in** — LitLab account via Supabase (aligned with the main stack described in the [main README](https://github.com/jackyuyz/litlab#readme)).
...
The mobile app does **not** try to replicate every LitLab web feature. Examples: no in-app PDF reader, no full AI action suite from the dashboard, no replacing the web UI for complex authoring. Use **[jackyuyz/litlab](https://github.com/jackyuyz/litlab)** for the complete workflow; use **this app** when you want quick mobile access to library, projects, and sharing.
...
- [LitLab (main project)](https://github.com/jackyuyz/litlab)
